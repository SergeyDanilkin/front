...
* используются препроцессоры [Pug](https://pugjs.org/) и [Stylus](https://stylus-lang.com)
...
## :keyboard: Команды
* ```yarn run lint:styles``` - проверить Stylus-файлы. Для VSCode необходимо установить [плагин](https://marketplace.visualstudio.com/items?itemName=shinnn.stylelint). Для WebStorm
...
* ```yarn run lint:styles --fix``` - исправить ошибки в Stylus-файлах согласно настройкам Stylelint
...
* шрифты находятся в папке ```src/fonts```
    ...
    * шрифты подключаются в файл ```src/styles/base/fonts.styl```
